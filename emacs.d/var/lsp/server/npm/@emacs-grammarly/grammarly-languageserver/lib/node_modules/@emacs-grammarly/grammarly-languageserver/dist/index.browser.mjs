import { BrowserMessageReader, BrowserMessageWriter, createConnection, ProposedFeatures, TextDocuments } from 'vscode-languageserver/browser';
import 'reflect-metadata';
import { injectable, inject, Container } from 'inversify';
import { TextDocument } from 'vscode-languageserver-textdocument';
import { createParser, transformers } from '@emacs-grammarly/grammarly-richtext-encoder';
import { parseDocument } from 'htmlparser2';
import { createStore, keys, get, delMany, del, set } from 'idb-keyval';
...
let DocumentService = class DocumentService {
    ...
    register() {
        ...
        __classPrivateFieldGet(this, _DocumentService_capabilities, "f").executeCommandProvider = {
        ...
        __classPrivateFieldGet(this, _DocumentService_connection, "f").onExecuteCommand(async (event) => {
            if (event.command === 'grammarly.dismiss' && event.arguments != null) {
                const [options] = event.arguments;
                const document = __classPrivateFieldGet(this, _DocumentService_documents, "f").get(options.uri);
                if (document == null)
                    return;
                await document.session.dismissSuggestion({ suggestionId: options.suggestionId });
...
class VirtualStorage {
    ...
    key(index) {
        var _a;
        return (_a = Array.from(this.items.keys())[index]) !== null && _a !== void 0 ? _a : null;
    }
    removeItem(key) {
...
class IDBStorage extends VirtualStorage {
    constructor() {
        super(...arguments);
